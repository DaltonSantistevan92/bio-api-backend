...
{
    public function permisosSi($rol_id){
        $response = [];
    ...
    public function permisosAppMovil($rol_id){
        $response = [];
        $accesos = Permiso::where('rol_id',intval($rol_id))->where('acceso','S')->where('guard', 'appMovil')->get();
    ...
    public function permisosAppWeb($rol_id){
        $response = [];
        $accesos = Permiso::where('rol_id',intval($rol_id))->where('acceso','S')->where('guard', 'appWeb')->get();
